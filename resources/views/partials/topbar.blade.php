        ...
        <nav class="navbar navbar-inverse navbar-toggleable-md">
            ...
            <div class="collapse navbar-collapse justify-content-md-center" id="cloapediamenu">
                <ul class="navbar-nav">
                    ...
                    @foreach (App\Services\DefaultService::getCategories() as $category)
                                ...
                                @foreach ($category->blogs as $key => $blog)
                                    @if ($key < 5)
                                        <li><a class="dropdown-item"
                                                ...
                                                {{ strip_tags( Str::limit( $blog->title , 20)) }}</a></li>
                                    @endif
                                @endforeach

                                @if ($category->blogs->count() > 5)
                                    <li><a class="dropdown-item" href="{{route('category.show' , Crypt::encrypt($category->id))}}">See more</a></li>
                                @endif
                                                    ...
                                                    <div class="blog-box">
                                                        ...
                                                        <div class="blog-meta">
                                                            <h4><a href="single.html" title="">The secret of
                                                                    your beauty is handmade soap</a></h4>
                                                        </div><!-- end meta -->
                                                    </div><!-- end blog-box -->
                                                </div>
                                                    ...
                                                    <div class="blog-box">
                                                        ...
                                                        <div class="blog-meta">
                                                            <h4><a href="single.html" title="">Relax with the
                                                                    unique warmth of candle flavor</a></h4>
                                                        </div><!-- end meta -->
                                                    </div><!-- end blog-box -->
                                                </div>
                                            </div><!-- end row -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="blog-box">
                                                        ...
                                                        <div class="blog-meta">
                                                            <h4><a href="single.html" title="">Which color is
                                                                    the most suitable color for you?</a></h4>
                                                        </div><!-- end meta -->
                                                    </div><!-- end blog-box -->
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="blog-box">
                                                        ...
                                                        <div class="blog-meta">
                                                            <h4><a href="single.html" title="">Subscribe to
                                                                    these sites to keep an eye on the fashion</a></h4>
                                                        </div><!-- end meta -->
                                                    </div><!-- end blog-box -->
                                                </div>
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="blog-box">
                                                        ...
                                                        <div class="blog-meta">
                                                            <h4><a href="single.html" title="">The most trends
                                                                    of this year with color combination</a></h4>
                                                        </div><!-- end meta -->
                                                    </div><!-- end blog-box -->
                                                </div>
                                            </div><!-- end row -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="blog-box">
                                                        ...
                                                        <div class="blog-meta">
                                                            <h4><a href="single.html" title="">I recommend you
                                                                    visit the fairy chimneys</a></h4>
                                                        </div><!-- end meta -->
                                                    </div><!-- end blog-box -->
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="blog-box">
                                                        ...
                                                        <div class="blog-meta">
                                                            <h4><a href="single.html" title="">A collection of
                                                                    the most beautiful shop designs</a></h4>
                                                        </div><!-- end meta -->
                                                    </div><!-- end blog-box -->
                                                </div>
                                                    ...
                                                    <div class="blog-box">
                                                        ...
                                                        <div class="blog-meta">
                                                            <h4><a href="single.html" title="">The most
                                                                    professional ways to color your walls</a></h4>
                                                        </div><!-- end meta -->
                                                    </div><!-- end blog-box -->
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="blog-box">
                                                        ...
                                                        <div class="blog-meta">
                                                            <h4><a href="single.html" title="">The world's
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                                    <div class="blog-box">
                                                        ...
                                                        <div class="blog-meta">
                                                            <h4><a href="single.html" title="">Tasty pasta
